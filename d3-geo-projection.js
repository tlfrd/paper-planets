...
var polyhedral = function(root, face, r) {
  ...
  // if d3-geo-polygon is available: run around the mesh of faces and stream all vertices
  // to create the clipping polygon
  ...
  proj.stream = function(stream) {
    var rotate = proj.rotate(),
        ...
        rotateStream = stream_(stream),
        sphereStream = ((preclip ? proj.preclip(function(s) { return s; }) : proj).rotate([0, 0]), stream_(stream));
    proj.rotate(rotate);
